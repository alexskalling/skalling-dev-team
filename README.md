...
| `/skalling-goal` | Completa un objetivo hasta un commit local, sin push |
...
| `/skalling-coverage` | Corre la cobertura de tests del proyecto y guarda el resultado real |
...
├── command/                          # Los 15 comandos /skalling-*
